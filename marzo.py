...
#Se seleccionan los años 2000-2008,marzo, Brownsville y Pedestrians
primer_mes = fronteras[es_Brow & (es_2008 | es_2007 | es_2006 | es_2005 | es_2004 | es_2003 | es_2002 | es_2001 | es_2000) & es_marzo &es_PD]
#print(primer_mes)
...
#media de 2000-2008 marzo
print("Media 2000-2008")
dd = primer_mes["Value"].mean()
print(dd)
print(" ")

#Desviación estándar de 2000-2008 marzo
...
#Se considera 278500.8 como hipoteisis alternativa
print("Valor crítico")
ffin = ((dd-278500.8)/(ds/dnfin))
print(ffin)
print(" ")


#Valor crítico = -0.009495227558807499 cae dentro de valor de z, por lo que la
...
plt.plot(x,y)
#plt.show()
plt.savefig('Brownsville - 2000-2008 - marzo.png')
